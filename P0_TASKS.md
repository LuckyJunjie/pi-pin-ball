...
| ID | 任务 | 负责人 | 状态 | 预估时间 | 来源 |
|----|------|--------|------|----------|------|
| T-P1-001 | 创建主菜单 | 程序团队 | ✅ 完成 | 1天 | MainMenu.tscn |
| T-P1-002 | 实现关卡系统 | 程序团队 | ✅ 完成 | 2天 | Flutter levels |
| T-P1-003 | 添加音效 | 程序团队 | ⚠️ 框架就绪 | 1天 | I/O Pinball |
| T-P1-004 | 实现角色系统 | 程序团队 | ✅ 完成 | 2天 | Flutter characters |
| T-P1-005 | 添加设置菜单 | 程序团队 | ✅ 完成 | 0.5天 | I/O Pinball |
...
| 版本 | 日期 | 更新内容 | 作者 |
|------|------|---------|------|
| 1.2 | 2026-02-19 | 更新P1任务状态，主菜单/关卡/角色/设置已完成 | Vanguard001 (Cron) |
