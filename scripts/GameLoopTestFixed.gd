...
func _test_score_system() -> void:
	...
	if game_manager:
		# 测试得分功能
		var initial_score = game_manager.get_score()
		game_manager.add_score(100)
		var new_score = game_manager.get_score()
		...
		# 测试倍率
		var initial_mult = game_manager.get_multiplier()
		game_manager.increase_multiplier()
		var new_mult = game_manager.get_multiplier()
...
func _test_game_over() -> void:
	...
	if game_manager:
		# 测试球数减少
		var initial_balls = game_manager.get_remaining_balls()
		game_manager.ball_lost()
		var new_balls = game_manager.get_remaining_balls()
